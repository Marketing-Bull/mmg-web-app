...
// The whole stored document, so a caller can report when the content last
// changed rather than when it was asked for. `updated` is stamped by
// writeJSON on every publish.
export async function readEventsDocument() {
...
export async function readEvents() {
  ...
  return document ? document.events : null;
}
